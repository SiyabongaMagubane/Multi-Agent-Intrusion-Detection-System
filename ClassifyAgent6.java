...
public class ClassifyAgent6 extends Agent {

	public ClassifyAgent6() {

	}

	@Override
	protected void setup() {
		System.out.println(" Hello classify Agent 6 is ready " + getAID().getName());
		/*
	...
	protected void takeDown() {
		...
		System.out.println("ClassifyAgent 6 " + getAID().getName() + " terminating");
	}
