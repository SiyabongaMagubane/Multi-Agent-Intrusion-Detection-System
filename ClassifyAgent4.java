...
public class ClassifyAgent4 extends Agent {

	public ClassifyAgent4() {

	}

	@Override
	protected void setup() {
		System.out.println(" Hello classify Agent 4 is ready " + getAID().getName());
		/*
	...
	protected void takeDown() {
		...
		System.out.println("ClassifyAgent 4 " + getAID().getName() + " terminating");
	}
