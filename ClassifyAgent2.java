...
public class ClassifyAgent2 extends Agent {

	public ClassifyAgent2() {

	}

	@Override
	protected void setup() {
		System.out.println(" Hello classify Agent 2 is ready " + getAID().getName());
		/*
	...
	protected void takeDown() {
		...
		System.out.println("ClassifyAgent 2" + getAID().getName() + " terminating");
	}
