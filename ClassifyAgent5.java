...
public class ClassifyAgent5 extends Agent {

	public ClassifyAgent5() {

	}

	@Override
	protected void setup() {
		System.out.println(" Hello classify Agent 5 is ready " + getAID().getName());
		/*
	...
	protected void takeDown() {
		...
		System.out.println("ClassifyAgent 5 " + getAID().getName() + " terminating");
	}
